...
- 📧 **Spam Mail Detector** — Machine Learning project to classify emails as spam or not spam.
- 🔍 **Java Search Engine** — Java-based search engine for keyword-based information retrieval.
...
To secure internships and build impactful AI-powered solutions that solve real-world problems.
